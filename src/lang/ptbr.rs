...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Desenvolvido por ConectDesk"),
        ("outgoing_only_desk_tip", "Acesso somente pelo portal ConectDesk.\nAbra a conexão pelo portal — este aplicativo não conecta manualmente."),
        ("preset_password_warning", "Aviso: este aplicativo é desassistido e usa uma senha predefinida. O acesso só é autorizado quando o portal ConectDesk libera a conexão."),
